...
<code>
p(.	git clone git://github.com/BinaryBurnout/timelogger.git
</code>
3. Navigate to the .java files and compile...
<code>
p(.	cd timelogger/src
p(.	javac TimeLogger.java
</code>
...
p(.	// To extract all contents of jar file...
p(.	jar xf timelogger.jar *

p(.	// To compile .java files...
p(.	javac TimeLogger.java

p(.	// To run application...
p(.	java TimeLogger
</code>
